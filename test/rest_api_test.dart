...
import 'package:tft/generated/l10n.dart';
import 'package:tft/models/local/token.dart';
import 'package:tft/pages/home/home_page.dart';
import 'package:tft/pages/home/home_provider.dart';
import 'package:tft/pages/login/login_page.dart';
...
import 'package:tft/services/cache/cache_preferences.dart';
import 'package:tft/services/cache/credential.dart';
        ...
        child: Builder(
          builder: (BuildContext context) {
            ...
            return MaterialApp(
              ...
              home:
                  (appRoute.generateRoute(const RouteSettings(name: AppRoute.routeLogin)) as MaterialPageRoute<dynamic>)
                      .builder(context),
