...
import 'package:tft/models/remote/login_response.dart';
import 'package:tft/pages/login/login_provider.dart';
...
import 'package:tft/services/safety/page_stateful.dart';
import 'package:tft/utils/app_extension.dart';
import 'package:tft/utils/app_helper.dart';
import 'package:tft/utils/app_log.dart';
import 'package:tft/utils/app_route.dart';
import 'package:tft/utils/app_style.dart';
import 'package:tft/widgets/p_appbar_transparency.dart';
import 'package:tft/widgets/w_env.dart';
import 'package:tft/widgets/w_input_form.dart';
import 'package:tft/widgets/w_keyboard_dismiss.dart';
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Image.asset(appTheme.assets.icAppIcon, width: 150.H, height: 150.H),
                ),
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      context.strings.btnRegister,
                      style: boldTextStyle(20.SP, color: Colors.red, fontFamily: appTheme.assets.fontRoboto),
                    ),
                  ),
                ),
