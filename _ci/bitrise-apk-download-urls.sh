...
#BITRISE_PERMANENT_DOWNLOAD_URL_MAP='app-universal-release.apk=>https://app.bitrise.io/artifact/thanhtq_depchai_xxxxx/download|app-release.aab=>https://app.bitrise.io/artifact/thanhtq_depchai_xxxxx/download|flutter_json_test_results.json=>https://app.bitrise.io/artifact/thanhtq_depchai_xxxxx/download'
