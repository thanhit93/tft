...
- Search and Replace All `tft` to new package name

### Change App display name

- Search and Replace All `Demo NFT App` to new App display name

### Change App bundle id

- Search and Replace All `com.thanhtq.tft` to new App bundle id
...
- git branch -M main
- git remote add origin https://github.com/thanhit93/tft.git
